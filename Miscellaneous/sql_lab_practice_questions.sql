...
-- 
-- Department Table
create table dept(deptcode varchar(15) primary key, deptname varchar(60), budget integer);
...
-- Designation Table
create table desig(desigcode varchar(15) primary key, designame varchar(15));

-- Salary Table
create table salary(empcode varchar(15), salmonth date not null, basic int, allow int, deduct int, primary key (empcode,salmonth));

-- Employee Table
create table emp(empcode varchar(15) primary key, empname varchar(60), deptcode varchar(15),birthdate date  not null, 
joindate date  not null, sex char(1) check (sex in ('M', 'F', 'T')),desigcode varchar(15), supcode varchar(15), 
gradecode varchar(15),gradelevel varchar(30), basicpay integer, foreign key (deptcode) references dept(deptcode), 
foreign key (desigcode) references desig(desigcode), foreign key (supcode) references emp(empcode),  
foreign key (gradecode, gradelevel) references grade (gradecode, gradelevel));

-- History Table
create table history(empcode varchar(15), changedate date not null, desigcode varchar(15), gradecode varchar(15), 
gradelevel varchar(30), basicpay int, primary key(empcode, changedate, desigcode, gradecode,gradelevel),
foreign key (empcode) references emp (empcode), foreign key (desigcode) references desig(desigcode),
foreign key (gradecode, gradelevel) references grade(gradecode, gradelevel));
...
insert into history (empcode,changedate,desigcode,gradecode,gradelevel,basicpay)
values( '7839', '1981-09-17',  'CLRK', 'GC15','GL1',  7000),
